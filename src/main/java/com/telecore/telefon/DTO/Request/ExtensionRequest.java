...
public record ExtensionRequest (
        ...
        @NotBlank(message = "El número de extensión es obligatorio")
        @Pattern(regexp = "^\\d{3,6}$", message = "El número debe tener entre 3 y 6 dígitos")
        String numero,

        @NotBlank(message = "La contraseña es obligatoria")
        String password,

        @NotBlank(message = "El nombre de la extensión es obligatorio")
        String nombre,
        ...
        @NotBlank(message = "necesario el contexto")
        Extension.Contexto contexto,

        @NotBlank(message = "necesasrop tipo de extension")
        Extension.TipoExtension tipoExtension,

        @NotBlank(message = "necesario el estado Extension")
        Extension.EstadoExtension estadoExtension,
